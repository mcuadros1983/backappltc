export const resumenMensualTemplate = (datos = {}) => {
    ...
    return {
        ...
        subject:
            `Resumen mensual de Evaluaciones - ${periodo}`,

        html: `
            <h2>📊 Resumen Mensual de Evaluaciones</h2>
            ...
            >
                ...
                <tr>
                    <td><strong>Evaluaciones generadas</strong></td>
                    <td>${evaluaciones}</td>
                </tr>
            ...
            <p>
                ...
                Este resumen permite realizar un seguimiento mensual
                del desempeño del proceso de evaluación y detectar
        ...
        text: `
Resumen Mensual de Evaluaciones

Período: ${periodo}
Sucursal: ${sucursal}

Evaluaciones generadas: ${evaluaciones}
