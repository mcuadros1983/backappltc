...
//     // ============ 3) Descripción del ABONO ============
//     let descFinal = (descripcion || "").trim();
//     if (!descFinal) {
//       descFinal = incluirNumerosComp && nrosComp.length
...
//       descFinal += ` · Pago con: ${formasTxt}`;
//     }

//     const hoy = new Date().toISOString().slice(0, 10);
//     const fechaAbono = fecha || hoy;

//     // ============ 3.5) Validar pagos y CREAR OP NUEVA (regla nueva) ============
...
//           estado: "aplicada",     // ajusta si usás otra convención
//           origen: "abono_ctacte",  // tag opcional
//           descripcion: descFinal?.slice(0, 250) || null,
...
//           console.log("nuevaOP", compIdUnico)
...
//     // ============ 7) Crear ABONO (vinculado a la OP nueva si existe) ============
...
//       comprobanteegreso_id: compIdUnico,
//       anulado: false,
//       ordenpago_id: ordenPagoIdToUse || null,   // <<<<< OP NUEVA o null si no hubo pagos
//       referencia_tipo: refTipo,
//       referencia_id: refId,
//       formapago_id: resolvedFormaPagoId,
//     }, { transaction: t });

//     // ============ 8) Insertar APLICACIONES ============
//     for (const a of aplicaciones) {
